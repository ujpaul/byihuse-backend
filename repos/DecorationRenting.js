      ...
      const { body } = await got.post(
        "https://api.flutterwave.com/v3/charges?type=mobile_money_rwanda",
        {
          json: {
            ...
            phone_number: phone,
            redirect_url:
              "https://byihuse.rw/#/en/session/thank-you-decoration",
            meta: "",
          },
          headers: {
  ...
  try {
    ...
    if (
      ...
      sendEmail.sendMail(
        ...
        `${odr.firstName} ${odr.lastName} has registerd decoration on byihuse`
      );
      return res;
    } else {
...
exports.getDecorationRentOrders = async (type) => {
  try {
